...
- **Sci-fi UI** — cinematic mission control dashboard
...
2. Run the installer
3. Download the latest **MissionControlMod** `.zip` from the Releases section and extract the GameData folder into your KSP root directory (merge when asked)
...
When running the installer, Windows SmartScreen may show a warning. Click **More info** → **Run anyway**. This is a known false positive with PyInstaller-built apps and is safe to bypass.
